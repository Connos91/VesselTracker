...
export function normaliseBearing(degrees: number): CompassDegrees {
...
function toRadians(position: Position): PositionRadians {
  return {
...
function angularDistance(from: PositionRadians, to: PositionRadians): number {
...
export const interpolatePosition = (from: Position, to: Position, fraction: number): Position => {
